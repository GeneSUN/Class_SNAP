...
def post_carrier(spark,date_str,id_column, xlap_enodeb_path, Enodeb_Pre_Feature_path, enodeb_date,enodeb_path): 
...
#----------------------------------------------------------------------------------------------------------------------------
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor: 
        executor.map(lambda enodeb_date: post_carrier(spark,
                                                     date_str,
                                                     id_column, 
                                                     xlap_carrier_path, 
                                                     Carrier_Pre_Feature_path, 
                                                     enodeb_date, 
                                                     enodeb_path), 
                                                                    previous_14_days) 
